...
from urllib.parse import quote as parse_quote  # noqa
from urllib.parse import unquote as parse_unquote  # noqa
from urllib.parse import urlparse as parse_urlparse  # noqa
from urllib.parse import urlunparse as parse_urlunparse  # noqa
