# Note: this is a copy of the types.py file from the mcp (python-sdk) package.
# https://github.com/modelcontextprotocol/python-sdk/blob/v1.9.2/src/mcp/types.py
#
# Original copyright notice:
# MIT License
# Copyright (c) 2024 Anthropic, PBC
#
# All changes copyright Sema4.ai,
# Apache-2.0
