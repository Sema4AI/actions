...
class KnowledgeBaseRecord(BaseModel):
    ...
    metadata: Annotated[
        Optional[Dict[str, Any]], Field(description="Optional metadata for the record")
    ] = None
...
class KnowledgeBaseInsertRequest(BaseModel):
    ...
    records: Annotated[
        ...
        Field(description="List of records to insert into the knowledge base"),
    ]
...
class SearchRequest(BaseModel):
    ...
    relevance_threshold: Annotated[
        float, Field(description="Minimum relevance score for results")
    ] = 0.5
...
class RecordFilter(BaseModel):
    ...
    record_ids: Annotated[
        Optional[List[str]],
        Field(description="List of record IDs to filter (optional)"),
    ] = None
    metadata_filters: Annotated[
        Optional[Dict[str, str]],
        Field(description="Metadata filters to apply (optional)"),
    ] = None
...
class ListRequest(BaseModel):
    ...
    filter: Annotated[
        Optional[RecordFilter], Field(description="Record filtering options (optional)")
    ] = None
    limit: Annotated[int, Field(description="Maximum number of records to return")] = (
        100
    )
...
class AdvancedSearchRequest(BaseModel):
    ...
    search: Annotated[SearchRequest, Field(description="Basic search parameters")]
    filter: Annotated[RecordFilter, Field(description="Record filtering options")]
